...
/* ─── Seed stops ─────────────────────────────────────────────── */
const SEED_STOPS = [
  { id:'s01',dayId:'d-1',order:1,segment:'kumano',name:'KUL → KIX',activity:'Night flight to Osaka Kansai',transport:'MH714 · depart 23:00 MYT · arrive 06:30+1 JST',transportType:'plane',time:'23:00',timeZone:'MYT',accommodation:null,notes:'',lat:null,lng:null,hasStamp:false,isSanzan:false,booking:{status:'booked',ref:'MH714',cost:null,deadline:null}},
  { id:'s02',dayId:'d0',order:1,segment:'kumano',name:'KIX → Kii-Tanabe',activity:'Collect JR Pass · head south by limited express',transport:'Haruka + Kuroshio Ltd Express · ~2.5 hrs',transportType:'train',time:'~09:30',timeZone:'JST',accommodation:'Kii-Tanabe (TBD)',notes:'',lat:33.7330,lng:135.3841,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s03',dayId:'d0',order:2,segment:'kumano',name:'Kumano Kodo Kan',activity:'Collect stamp passport (¥100) · trail maps · last gear',transport:'Walking distance from station',transportType:'walk',time:'~12:00',timeZone:'JST',accommodation:null,notes:'Open 8:30–17:15',lat:33.7748,lng:135.5037,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s04',dayId:'d1',order:1,segment:'kumano',name:'Takijiri-oji',activity:'Trailhead start · Tainai-kuguri womb-crawling rock',transport:'Bus/taxi from Kii-Tanabe · ~40 min',transportType:'bus',time:'~09:00',timeZone:'JST',accommodation:null,notes:'~3.6 km, 1.5–2 hrs to Takahara',lat:33.7757,lng:135.5037,hasStamp:true,stampKanji:'始点',stampRomaji:'Takijiri',isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s05',dayId:'d1',order:2,segment:'kumano',name:'Takahara Lodge',activity:'Arrive ridge village · onsen at the lodge',transport:'On foot · 3.6 km',transportType:'walk',time:'~11:30',timeZone:'JST',accommodation:'Kiri-no-Sato Takahara Lodge',notes:'Stunning sunrise/mist views',lat:33.7959,lng:135.5321,hasStamp:true,stampKanji:'高原',stampRomaji:'Takahara',isSanzan:false,booking:{status:'pending',ref:'',cost:18000,deadline:'2027-01-15'}},
  ...
  { id:'s11',dayId:'d3',order:3,segment:'kumano',name:'Kumano Hongu Taisha',activity:'First Kumano Sanzan stamp · goshuincho main shrine',transport:'On foot',transportType:'walk',time:'~12:00',timeZone:'JST',accommodation:null,notes:'Shrine office 8:00–17:00',lat:33.8406,lng:135.7735,hasStamp:true,stampKanji:'本宮',stampRomaji:'Hongu',isSanzan:true,sanzanNum:1,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s12',dayId:'d3',order:4,segment:'kumano',name:'Yunomine Onsen',activity:'Foot bath + Tsuboyu private bath (UNESCO listed)',transport:'Bus from Hongu · ~15 min',transportType:'bus',time:'~13:30',timeZone:'JST',accommodation:'Kawayu Onsen (TBD)',notes:'Reserve Tsuboyu in advance — limited slots',lat:33.8293,lng:135.7576,hasStamp:true,stampKanji:'湯峯',stampRomaji:'Yunomine',isSanzan:false,booking:{status:'urgent',ref:'',cost:null,deadline:'2027-02-01'}},
  { id:'s13',dayId:'d4',order:1,segment:'kumano',name:'Kawayu Onsen',activity:'Free morning · riverside hot spring pools',transport:'',transportType:null,time:'Morning',timeZone:'JST',accommodation:'Kawayu Onsen (TBD)',notes:'River pools open to all',lat:33.8132,lng:135.7725,hasStamp:true,stampKanji:'川湯',stampRomaji:'Kawayu',isSanzan:false,booking:{status:'pending',ref:'',cost:null,deadline:'2027-01-15'}},
  { id:'s14',dayId:'d4',order:2,segment:'kumano',name:'Hongu Spring Matsuri',activity:'Spring festival at Kumano Hongu Taisha',transport:'Hotel shuttle or bus',transportType:'bus',time:'~14:00',timeZone:'JST',accommodation:null,notes:'Confirm exact 2027 festival date with shrine',lat:33.8406,lng:135.7735,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s15',dayId:'d5',order:1,segment:'kumano',name:'Kumano-gawa Riverboat',activity:'Traditional boat Hongu → Hayatama Taisha',transport:'Riverboat · ~90 min',transportType:'boat',time:'~09:00',timeZone:'JST',accommodation:null,notes:'Seasonal / limited — book ASAP',lat:33.8406,lng:135.7735,hasStamp:false,isSanzan:false,booking:{status:'urgent',ref:'',cost:null,deadline:'2027-02-01'}},
  { id:'s16',dayId:'d5',order:2,segment:'kumano',name:'Kumano Hayatama Taisha',activity:'Second Kumano Sanzan stamp',transport:'Boat drop-off',transportType:null,time:'~10:45',timeZone:'JST',accommodation:null,notes:'Shingu shrine precinct',lat:33.7322,lng:135.9835,hasStamp:true,stampKanji:'速玉',stampRomaji:'Hayatama',isSanzan:true,sanzanNum:2,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s17',dayId:'d5',order:3,segment:'kumano',name:'Kii-Katsuura',activity:'Coastal onsen town · tuna market visit',transport:'Train Shingu → Katsuura · ~25 min',transportType:'train',time:'~13:00',timeZone:'JST',accommodation:'Central Katsuura (TBD)',notes:'',lat:33.6282,lng:135.9414,hasStamp:false,isSanzan:false,booking:{status:'pending',ref:'',cost:null,deadline:'2027-02-01'}},
  { id:'s18',dayId:'d6',order:1,segment:'kumano',name:'Daimon-zaka',activity:'Ancient cedar-lined stone staircase',transport:'Bus from Katsuura · ~20 min',transportType:'bus',time:'~09:00',timeZone:'JST',accommodation:null,notes:'',lat:33.6713,lng:135.8976,hasStamp:true,stampKanji:'大門',stampRomaji:'Daimon-zaka',isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s19',dayId:'d6',order:2,segment:'kumano',name:'Kumano Nachi Taisha',activity:'Third Kumano Sanzan stamp · full set complete',transport:'On foot',transportType:'walk',time:'~10:00',timeZone:'JST',accommodation:null,notes:'Pagoda + waterfall view · Nachi Falls nearby',lat:33.6687,lng:135.8901,hasStamp:true,stampKanji:'那智',stampRomaji:'Nachi',isSanzan:true,sanzanNum:3,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s20',dayId:'d6',order:3,segment:'osaka',name:'Nagoya',activity:'Overnight stop heading north for Alpine Route',transport:'Local train depart ~12:25 · arr ~16:30',transportType:'train',time:'~12:25',timeZone:'JST',accommodation:'Nagoya (TBD)',notes:'Or Shinkansen 17:11 dep',lat:35.1709,lng:136.8815,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s21',dayId:'d7',order:1,segment:'alpine',name:'Tateyama Station',activity:'Alpine Route start · cable car + highland bus',transport:'Cable car to Bijodaira',transportType:'cable',time:'~07:30',timeZone:'JST',accommodation:null,notes:'13–18 m snow walls expected',lat:36.5833,lng:137.4455,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s22',dayId:'d7',order:2,segment:'alpine',name:'Kurobe Dam',activity:'Ropeway + cable car + dam walk',transport:'Ropeway / cable car',transportType:'cable',time:'~11:00',timeZone:'JST',accommodation:null,notes:'Highest dam in Japan · 186 m',lat:36.5675,lng:137.6650,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s23',dayId:'d7',order:3,segment:'alpine',name:'Ogizawa',activity:'Exit point of Alpine Route · electric bus terminus',transport:'Electric bus',transportType:'bus',time:'~14:00',timeZone:'JST',accommodation:null,notes:'Luggage transfer ~¥4,400',lat:36.5592,lng:137.7210,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s24',dayId:'d7',order:4,segment:'hakuba',name:'Shinano-Omachi',activity:'Overnight — better dining options than Ogizawa',transport:'Local bus · ~40 min (last bus 17:05)',transportType:'bus',time:'~15:10',timeZone:'JST',accommodation:'Shinano-Omachi (TBD)',notes:'',lat:36.4999,lng:137.8613,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s25',dayId:'d8',order:1,segment:'hakuba',name:'Shinano-Omachi → Hakuba',activity:'Short hop to Hakuba — check in early',transport:'JR Oito Line · ~40 min',transportType:'train',time:'~09:00',timeZone:'JST',accommodation:'The Happo Hakuba or Evo Brand',notes:'',lat:36.6982,lng:137.8619,hasStamp:false,isSanzan:false,booking:{status:'pending',ref:'',cost:null,deadline:'2027-02-01'}},
  { id:'s26',dayId:'d9',order:1,segment:'hakuba',name:'Tsugaike Kogen',activity:'Guided snowshoe trek · deep April snowpack',transport:'Local shuttle / taxi',transportType:'bus',time:'~09:00',timeZone:'JST',accommodation:'Hakuba (same)',notes:'Book local operator · gear included',lat:36.7492,lng:137.8661,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s27',dayId:'d10',order:1,segment:'hakuba',name:'Oide Park',activity:'Cherry blossom vs Shirouma Sanzan mountains',transport:'15 min walk from Hakuba Station',transportType:'walk',time:'~09:00',timeZone:'JST',accommodation:null,notes:'Peak bloom typically late April',lat:36.6964,lng:137.8737,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s28',dayId:'d10',order:2,segment:'hakuba',name:'Hakuba Onsen',activity:'Soak to close the day',transport:'Local',transportType:null,time:'~15:00',timeZone:'JST',accommodation:'Hakuba (same)',notes:'Wadano / Hakuba-no-Yu',lat:36.6982,lng:137.8619,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s29',dayId:'d11',order:1,segment:'hakuba',name:'Hakuba → Matsumoto',activity:'Depart south via JR Oito Line',transport:'JR Oito Line · ~70 min',transportType:'train',time:'~09:00',timeZone:'JST',accommodation:null,notes:'',lat:36.2308,lng:137.9644,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s30',dayId:'d11',order:2,segment:'osaka',name:'Matsumoto → Nagoya',activity:'Transfer — build buffer time',transport:'Shinano Ltd Express · ~2 hrs',transportType:'train',time:'~10:49',timeZone:'JST',accommodation:null,notes:'Allow buffer at Matsumoto',lat:35.1709,lng:136.8815,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s31',dayId:'d11',order:3,segment:'osaka',name:'Nagoya → Osaka',activity:'Final Shinkansen leg',transport:'Tokaido Shinkansen · ~50 min',transportType:'train',time:'~13:25',timeZone:'JST',accommodation:'Osaka (TBD)',notes:'~5 hrs door-to-door from Hakuba',lat:34.7025,lng:135.4960,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
  { id:'s32',dayId:'d12',order:1,segment:'osaka',name:'Osaka',activity:'Free block — Nara day trip, city food, downtime',transport:'',transportType:null,time:'Free',timeZone:'JST',accommodation:'Osaka (TBD)',notes:'Open block — plan on the ground',lat:34.7025,lng:135.4960,hasStamp:false,isSanzan:false,booking:{status:'open',ref:'',cost:null,deadline:null}},
];
...
const SEED_PACKING = [
  ...
  {id:'pk31',cat:'Pilgrim',item:'Small amount of yen cash (vending / stamps)',checked:false,essential:true},
];
...
/* ─── Public API ─────────────────────────────────────────────── */
const Data = {
  /* Boot — load from IndexedDB, fall back to seed */
  async init() {
    try {
      ...
      if (dbPack?.length) PACKING = dbPack;
      else await DB.savePacking(PACKING);
    } catch(e) {
      console.warn('[Data.init]', e);
    }
  },

  /* Setters used by Sync */
  setStops(stops)          { STOPS = stops; },
  setExpenses(exp)         { EXPENSES = exp; },
  setPackingItems(items)   { PACKING = items; },
  ...
  getTotalSpentJPY() { return EXPENSES.reduce((s, e) => s + (e.amountJPY || 0), 0); },
